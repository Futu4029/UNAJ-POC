...
$insertar = "INSERT INTO empresa(nombre_empresa, cuit, provincia, localidad, direccion, telefono, mail) 
             VALUES ('$nombre_empresa', '$cuit', '$provincia', '$localidad', '$direccion', '$telefono', '$mail')";
